...
path = [linspace(robposB(1),st1(1),10);linspace(robposB(3),st1(3),10)]';
% path = float(path)
...
% robotCurrentPose2 = [st1(1);st1(3);atan2(st1(1),st1(3))]
%     robotCurrentPose
...
%     hold on
%         plotTrVec = [robotCurrentPose2(1:2); 0];
%     plotRot = axang2quat([0 0 1 robotCurrentPose2(3)]);
%         plotTransforms(plotTrVec', plotRot, "MeshFilePath", "fixedwing.stl", "Parent", gca, "View","2D", "FrameSize", frameSize);
