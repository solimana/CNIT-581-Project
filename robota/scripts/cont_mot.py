...
def cont_mot_node():
    ...
    while not rospy.is_shutdown():
        rospy.Subscriber("/motorsA", Float32MultiArray, motors_callback)
        # PWM.setMotorModel(motors_arry[0],motors_arry[0],motors_arry[1],motors_arry[1])
        rate.sleep()
